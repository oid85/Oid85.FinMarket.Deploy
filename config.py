...
finmarket_source_path = 'C:\\Repository\\Oid85.FinMarket\\Oid85.FinMarket'
finmarket_deploy_directory = 'Oid85.FinMarket'
finmarket_exe_file_name = "Oid85.FinMarket.WebHost.exe"
